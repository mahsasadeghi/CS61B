...
class Fraction {
  ...
  public static void main(String[] argv) {
    ...
    Fraction sumOfTwo = new Fraction(f2.denominator*f1.numerator+f1.denominator*f2.numerator,
                                     f1.denominator*f2.denominator);
    Fraction sumOfThree = new Fraction(f2.denominator*f0.denominator*f1.numerator+
                                       f1.denominator*f0.denominator*f2.numerator+
                                       f1.denominator*f2.denominator*f0.numerator,
                                       f1.denominator*f2.denominator*f0.denominator);
